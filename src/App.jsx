...
const DATA = {
  ...
  projects: [
    ...
    },
    {
      ...
      type: "UI/UX | 3D Design",
      tags: ["Figma", "Framer", "Spline"],
      desc: "Prototyped a premium 3D product UI for Master & Dynamic with immersive spatial design, motion interactions, and high-fidelity visual components.",
      feats: ["Premium product UI design", "3D spatial architecture", "Motion & interaction design", "High-fidelity Figma components"],
      demo: "https://maxheadphones.framer.website/",
    },
    {
      name: "3D UI Design — Gallsi",
      type: "UI/UX | 3D Design",
      tags: ["Figma", "Framer", "Spline"],
      desc: "Designed a complete 3D UI system for Gallsi using Spline for spatial elements, with attention to depth, usability, and interactive motion across the interface.",
      feats: ["Spline 3D element integration", "Full UI system design", "Depth & usability focus", "Interactive motion prototyping"],
      demo: "https://www.figma.com/proto/xi8pOim1BoPCDKW7ZJ2y3q/Untitled?page-id=0%3A1&node-id=1-3&scaling=scale-down-width&content-scaling=fixed&t=i1ZU0lydyCuWSFHq-1",
    },
  ],
  experience: [
    {
